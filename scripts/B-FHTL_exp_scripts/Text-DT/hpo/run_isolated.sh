...
do
    ...
    --cfg scripts/B-FHTL_exp_scripts/Text-DT/config_isolated.yaml \
    --cfg_client scripts/B-FHTL_exp_scripts/Text-DT/config_client_isolated.yaml \
    device ${cudaid} \
