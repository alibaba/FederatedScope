...
from federatedscope.contrib.trainers.trainer_maml import call_maml_trainer
from federatedscope.contrib.metrics.metric_builder import call_sts_metric, call_squad_metric
...
def register_all():
    ...
    register_trainer('text-dt', call_my_trainer)
