    ...
    def callback_funcs_model_para(self, message: Message):
        ...
        if self.state_to_reconstruct is None or message.state in \
            ...
            if self.client_to_reconstruct is None or message.sender in \
                ...
                logger.info('Finish DLG attack; Final DLG reconstruction loss: {}'.format(self.reconstructor.dlg_recover_loss))
                self.best_results['DLG_loss'][round][sender] = self.reconstructor.dlg_recover_loss
