...
DEVICE=$1
CFG=federatedscope/nlp/prompt_learning/baseline/config_freeze.1.yaml
...
OUT=exp/isolated_opt1.3b/lr5ef3_ls100_pre100/
ROUND_NUM=100
LOCAL_STEPS=100
BATCH_SIZE=16
GRAD_ACCUM=1
SERVER_PREFIX_LEN=100
CLIENT_PREFIX_LEN=100
NUM_CLIENT=1
