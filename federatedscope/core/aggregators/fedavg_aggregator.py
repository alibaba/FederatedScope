...
class FedAvgAggregator(Aggregator):
    ...
    def aggregate(self, agg_info):
        ...
        pure_models = [model[0] for model in models]
        avg_model = self._para_weighted_avg(pure_models, recover_fun=recover_fun)
        this_round_id = [model[-1] for model in models]
        return avg_model, this_round_id
...
class OnlineClientsAvgAggregator(FedAvgAggregator):
    """
