...
def get_sampler(sample_strategy='uniform', client_num=None, client_info=None, bins=10):
    if sample_strategy == 'uniform':
        ...
        raise ValueError(f"The sample strategy {sample_strategy} has not been provided.")