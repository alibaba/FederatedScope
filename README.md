...
A detailed tutorial is provided on our [website](https://federatedscope.io/), and you can try FederatedScope in the [FederatedScope Playground](https://try.federatedscope.io/) or [Google Colab](https://colab.research.google.com/github/alibaba/FederatedScope).
