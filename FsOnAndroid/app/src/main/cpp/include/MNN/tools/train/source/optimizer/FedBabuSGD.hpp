...
#ifndef FedBabuSGD_hpp
#define FedBabuSGD_hpp
...
class MNN_PUBLIC FedBabuSGD : public ParameterOptimizer {
public:
    FedBabuSGD(std::shared_ptr<Express::Module> module);
    virtual ~ FedBabuSGD() = default;
