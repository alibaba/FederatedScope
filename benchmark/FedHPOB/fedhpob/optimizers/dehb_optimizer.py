...
def run_dehb(cfg):
    ...
    if cfg.optimizer.type == 'de':
        optimizer = DE(
            cs=cfg.benchmark.configuration_space[0], dimensions=len(
                cfg.benchmark.configuration_space[0].get_hyperparameters()),
            f=objective, pop_size=cfg.optimizer.dehb.de.pop_size,
