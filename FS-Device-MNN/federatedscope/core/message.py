...
class Message(object):
    ...
    def timestamp(self, value):
        assert isinstance(value, int) or isinstance(value, float) or isinstance(value, str), \
            "We only support an int, float or string value for timestamp"
    ...
    def __lt__(self, other):
        ...
        raise NotImplementedError("Comparison among messages is not implemented")
