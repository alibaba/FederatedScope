...
def extend_fl_setting_cfg(cfg):
    ...
    cfg.federate.seen_client_num = -1
    cfg.federate.executor_num = -1
    cfg.federate.min_received_num = -1

    cfg.federate.agg_time_budget = 9999999
    cfg.federate.upt_time_budget = True
    cfg.federate.agg_lower_bound = -1
    ...
    cfg.distribute.grpc_compress = ''   # one of ['', 'gzip', 'deflate']

    cfg.distribute.mnn_compress = ''
